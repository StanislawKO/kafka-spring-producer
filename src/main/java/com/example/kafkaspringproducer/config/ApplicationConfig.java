package com.example.kafkaspringproducer.config;

import com.example.kafkaspringproducer.model.StringValue;
import com.example.kafkaspringproducer.service.DataSender;
import com.example.kafkaspringproducer.service.DataSenderKafka;
import com.example.kafkaspringproducer.service.StringValueSource;
...
public class ApplicationConfig {
    ...
    public ProducerFactory<String, StringValue> producerFactory(
            KafkaProperties kafkaProperties, ObjectMapper mapper, ObjectProvider<SslBundles> sslBundles) {
        var props = kafkaProperties.buildProducerProperties(sslBundles.getIfAvailable());
